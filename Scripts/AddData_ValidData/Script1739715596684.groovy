...
WebUI.click(findTestObject('Object Repository/AddUserObjects/Page_OrangeHRM/span_Admin'))

WebUI.click(findTestObject('Object Repository/AddUserObjects/Page_OrangeHRM/button_Add'))
...
WebUI.setText(findTestObject('Object Repository/AddUserObjects/Page_OrangeHRM/input_Username_oxd-input oxd-input--focus'), 
    'ranga11')

WebUI.verifyElementText(findTestObject('Object Repository/AddUserObjects/Page_OrangeHRM/label_Password_1'), 'Password')
...
WebUI.verifyElementVisible(findTestObject('Object Repository/AddUserObjects/Page_OrangeHRM/p_Successfully Saved'))
